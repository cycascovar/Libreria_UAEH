...
<html>
  <head>
    ...
    <title><g:if test="${params.q && params.q?.trim() != ''}">${params.q} - </g:if>Buscar</title> </head>
  ...
  <div id="header2">
    <h1><a href="http://grails.org/Searchable+Plugin" target="_blank">Buscar Libro</a></h1>
  ...
  <div id="main">
    ...
    <g:if test="${haveQuery && !haveResults && !parseException}">
      <p>No se encuentra a - <strong>${params.q}</strong></p>
      ...
      <div class="results">
        <g:each var="result" in="${searchResult.results}" status="index">
          <div class="result">
            ...
            <div class="name"><a href="${link}">${className} #${result.id}
            <g:set var="desc" value="${result.toString()}" /></a></div>
