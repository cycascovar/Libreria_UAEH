		...
		<div id="show-userRole" class="content scaffold-show" role="main">
			...
			<ol class="property-list userRole">
				...
				<li class="fieldcontain">
					<span id="role-label" class="property-label"><g:message code="userRole.role.label" default="Rol" /></span>
				...
				<li class="fieldcontain">
					<span id="user-label" class="property-label"><g:message code="userRole.user.label" default="Cuenta" /></span>
